import Read_Clinic_Excel_Sheet
import Write_Clinic_Excel_Sheet
...
print("****************************************************************************")
print("*                                                                          *")
print("*                   Welcome clinic Management System                     *")
print("*                                                                          *")
print("****************************************************************************")
...
while tries_flag != "Close the program" :
		...
		Pateints_DataBase = Read_Clinic_Excel_Sheet.Read_Patients_DataBase()
		Doctors_DataBase  = Read_Clinic_Excel_Sheet.Read_Doctors_DataBase()
		...
		if Admin_user_mode == "1" :																			#Admin mode
				...
				while True :
					...
					Write_Clinic_Excel_Sheet.Write_Patients_DataBase(Pateints_DataBase)
					Write_Clinic_Excel_Sheet.Write_Doctors_DataBase(Doctors_DataBase)
